...
<Card class="border border-border">
  ...
  <Collapsible bind:open={lfmOpen} title={$_('lastfm.title')}>
    ...
    <div class="mt-3 p-3 bg-muted/50 rounded-md">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <label class="text-xs font-medium min-w-[80px]">{$_('lastfm.library')}</label>
        <Switch bind:checked={user.lastfm.playlist.library.enabled} />
        <Input
          bind:value={user.lastfm.playlist.library.name}
          placeholder={$_('lastfm.library_placeholder')}
          class="min-w-[100px] flex-1"
        />
        <Input type="number" bind:value={user.lastfm.playlist.library.limit} placeholder="50" min="0" class="w-16" />
      </div>
    </div>
  </Collapsible>
  ...
  <Collapsible bind:open={lbOpen} title={$_('listenbrainz.title')}>
    ...
    <div class="mt-3 p-3 bg-muted/50 rounded-md">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <label class="text-xs font-medium min-w-[80px]">{$_('listenbrainz.loved_tracks')}</label>
        <Switch bind:checked={user.listenbrainz.playlist.loved_tracks.enabled} />
        <Input
          bind:value={user.listenbrainz.playlist.loved_tracks.name}
          placeholder={$_('listenbrainz.loved_tracks_placeholder')}
          class="min-w-[100px] flex-1"
        />
        <Input
          type="number"
          bind:value={user.listenbrainz.playlist.loved_tracks.limit}
          placeholder="0"
          min="0"
          class="w-16"
        />
